  ...
  return (
    <main className="w-full bg-linear-to-br from-[#e0f7fa] via-[#f8fafc] to-[#e0f2fe] flex flex-col">
      <section
        ...
        className="bg-[#0c4423]"
      >
        <Header title={"Terms & Conditions"} backgroundImage={""} />
      </section>
      <section className="flex justify-center my-10">
        <div className="max-w-3xl bg-white rounded-xl shadow-lg p-8 text-sm">
          ...
          <p className="mb-4">
            ...
            .{" "}
            <span className="font-semibold text-emerald-700">
              &ldquo;you&rdquo;, &ldquo;your&rdquo;, &ldquo;user&rdquo;,
              &ldquo;visitor&rdquo;
            </span>{" "}
          ...
          <ul className="list-disc list-inside mb-4 space-y-2">
            ...
            <li>
              ...
              document without OUTBOUND TRAVELERS&apos;s prior written consent.
            </li>
            <li>
